<?php
namespace Magento\GiftRegistry\Block\Product\View;

/**
 * Interceptor class for @see \Magento\GiftRegistry\Block\Product\View
 */
class Interceptor extends \Magento\GiftRegistry\Block\Product\View implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setGiftRegistryTemplate');
        if (!$pluginInfo) {
            return parent::setGiftRegistryTemplate($blockName, $template);
        } else {
            return $this->___callPlugins('setGiftRegistryTemplate', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setGiftRegistryUrl');
        if (!$pluginInfo) {
            return parent::setGiftRegistryUrl($blockName);
        } else {
            return $this->___callPlugins('setGiftRegistryUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAddToGiftregistryUrl');
        if (!$pluginInfo) {
            return parent::getAddToGiftregistryUrl();
        } else {
            return $this->___callPlugins('getAddToGiftregistryUrl', func_get_args(), $pluginInfo);
        }
    }
