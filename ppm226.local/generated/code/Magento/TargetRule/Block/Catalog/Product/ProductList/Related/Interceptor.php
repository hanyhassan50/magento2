<?php
namespace Magento\TargetRule\Block\Catalog\Product\ProductList\Related;

/**
 * Interceptor class for @see \Magento\TargetRule\Block\Catalog\Product\ProductList\Related
 */
class Interceptor extends \Magento\TargetRule\Block\Catalog\Product\ProductList\Related implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Catalog\Block\Product\Context $context, \Magento\TargetRule\Model\ResourceModel\Index $index, \Magento\TargetRule\Helper\Data $targetRuleData, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $visibility, \Magento\TargetRule\Model\IndexFactory $indexFactory, \Magento\Checkout\Model\Cart $cart, array $data = array())
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductListType');
        if (!$pluginInfo) {
            return parent::getProductListType();
        } else {
            return $this->___callPlugins('getProductListType', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExcludeProductIds');
        if (!$pluginInfo) {
            return parent::getExcludeProductIds();
        } else {
            return $this->___callPlugins('getExcludeProductIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPositionLimit');
        if (!$pluginInfo) {
            return parent::getPositionLimit();
        } else {
            return $this->___callPlugins('getPositionLimit', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPositionBehavior');
        if (!$pluginInfo) {
            return parent::getPositionBehavior();
        } else {
            return $this->___callPlugins('getPositionBehavior', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkCollectionCount');
        if (!$pluginInfo) {
            return parent::getLinkCollectionCount();
        } else {
            return $this->___callPlugins('getLinkCollectionCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRuleBasedBehaviorPositions');
        if (!$pluginInfo) {
            return parent::getRuleBasedBehaviorPositions();
        } else {
            return $this->___callPlugins('getRuleBasedBehaviorPositions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSelectedBehaviorPositions');
        if (!$pluginInfo) {
            return parent::getSelectedBehaviorPositions();
        } else {
            return $this->___callPlugins('getSelectedBehaviorPositions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkCollection');
        if (!$pluginInfo) {
            return parent::getLinkCollection();
        } else {
            return $this->___callPlugins('getLinkCollection', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isShuffled()
    {
        ...
        if (!$pluginInfo) {
            return parent::isShuffled();
        } else {
            return $this->___callPlugins('isShuffled', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'compareItems');
        if (!$pluginInfo) {
            return parent::compareItems($item1, $item2);
        } else {
            return $this->___callPlugins('compareItems', func_get_args(), $pluginInfo);
        }
    }
