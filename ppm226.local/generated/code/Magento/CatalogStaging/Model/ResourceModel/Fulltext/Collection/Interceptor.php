...
class Interceptor extends \Magento\CatalogStaging\Model\ResourceModel\Fulltext\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setSearch(\Magento\Search\Api\SearchInterface $object)
    {
        ...
        if (!$pluginInfo) {
            return parent::setSearch($object);
        } else {
    ...
    public function setSearchCriteriaBuilder(\Magento\Framework\Api\Search\SearchCriteriaBuilder $object)
    {
        ...
        if (!$pluginInfo) {
            return parent::setSearchCriteriaBuilder($object);
        } else {
            return $this->___callPlugins('setSearchCriteriaBuilder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setFilterBuilder(\Magento\Framework\Api\FilterBuilder $object)
    {
        ...
        if (!$pluginInfo) {
            return parent::setFilterBuilder($object);
        } else {
            return $this->___callPlugins('setFilterBuilder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setGeneralDefaultQuery()
    {
        ...
        if (!$pluginInfo) {
            return parent::setGeneralDefaultQuery();
        } else {
            return $this->___callPlugins('setGeneralDefaultQuery', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getFacetedData($field)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getFacetedData', func_get_args(), $pluginInfo);
        }
    }
