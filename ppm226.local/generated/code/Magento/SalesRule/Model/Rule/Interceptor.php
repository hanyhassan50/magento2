...
class Interceptor extends \Magento\SalesRule\Model\Rule implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getCouponCodeGenerator()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCouponCodeGenerator();
        } else {
            return $this->___callPlugins('getCouponCodeGenerator', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setCouponCodeGenerator(\Magento\SalesRule\Model\Coupon\CodegeneratorInterface $codeGenerator)
    {
        ...
        if (!$pluginInfo) {
            return parent::setCouponCodeGenerator($codeGenerator);
        } else {
            return $this->___callPlugins('setCouponCodeGenerator', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getPrimaryCoupon()
    {
        ...
        if (!$pluginInfo) {
            return parent::getPrimaryCoupon();
        } else {
            return $this->___callPlugins('getPrimaryCoupon', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getStoreLabel($store = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getStoreLabel($store);
        } else {
    ...
    public function getCoupons()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getCoupons', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCouponTypes()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCouponTypes();
        } else {
            return $this->___callPlugins('getCouponTypes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function acquireCoupon($saveNewlyCreated = true, $saveAttemptCount = 10)
    {
        ...
        if (!$pluginInfo) {
            return parent::acquireCoupon($saveNewlyCreated, $saveAttemptCount);
        } else {
            return $this->___callPlugins('acquireCoupon', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function hasIsValidForAddress($address)
    {
        ...
        if (!$pluginInfo) {
            return parent::hasIsValidForAddress($address);
        } else {
            return $this->___callPlugins('hasIsValidForAddress', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setIsValidForAddress($address, $validationResult)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('setIsValidForAddress', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getIsValidForAddress($address)
    {
        ...
        if (!$pluginInfo) {
            return parent::getIsValidForAddress($address);
        } else {
            return $this->___callPlugins('getIsValidForAddress', func_get_args(), $pluginInfo);
        }
    }
